 ...
 * @author jessi
 */
public class DeleteEngagementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean res = bd.delete(eng);
        if(res){
            String message = "L'engagement de l'adherent code:" + eng.getIdMateriel() + "a la machine code: " + eng.getCodeAdherent() + " est supprimmée";
